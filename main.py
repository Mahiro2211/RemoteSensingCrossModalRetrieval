...
def run(args):
    ...
    if args.dataset == "rsitmd":
        train_set = re_train_dataset(
            ann_file=["./data/finetune_json/rsitmd_train.json"],
            transform=preprocess_train,
            image_root="./dataset/rsitmd",
        )
        test_set = re_eval_dataset(
            ann_file="./data/finetune_json/rsitmd_test.json",
    ...
    train_loader = DataLoader(
        train_set, batch_size=args.bs, pin_memory=True, shuffle=True, num_workers=12
    )
