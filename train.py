...
def itm_eval(scores_i2t, scores_t2i, txt2img, img2txt):
    ...
    if eval_result['img_r1'] > best_i2t_r1:
        best_i2t_r1 = eval_result['img_r1']
    if eval_result['img_r5'] > best_i2t_r5:
        best_i2t_r5 = eval_result['img_r5']
    if eval_result['img_r10'] > best_i2t_r10:
        best_i2t_r10 = eval_result['img_r10']

    if eval_result['txt_r1'] > best_t2i_r1:
        best_t2i_r1 = eval_result['txt_r1']
    if eval_result['txt_r5'] > best_t2i_r5:
        best_t2i_r5 = eval_result['txt_r5']
    if eval_result['txt_r10'] > best_t2i_r10:
